...
csv_path = os.path.join(OUT_DIR, "tension_to_tempo.csv")
...
plt.xlabel("Time (sec)")
plt.ylabel("Signal")
plt.title("Warner Mirror: Tension Curve → Tempo Map (Proof)")
png_path = os.path.join(OUT_DIR, "tension_curve.png")
